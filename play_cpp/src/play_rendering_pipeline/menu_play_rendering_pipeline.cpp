...
r2tm::WriteFunctionT Menu_Play_Rendering_Pipeline::GetWriteFunction() const
{
	return[]( r2tm::MenuProcessor* mp )
	{
		...
		mp->AddItem( 'z', play_rendering_pipeline::ProjectionMatrix_Orthographic_Z_Range() );
		mp->AddItem( 'x', play_rendering_pipeline::ProjectionMatrix_Perspective_Z_Range() );
		mp->AddItem( 'c', play_rendering_pipeline::Composition() );
		...
		mp->AddItem( 32, play_rendering_pipeline::Demo() );
