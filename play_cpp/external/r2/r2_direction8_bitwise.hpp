...
// - 0.0.1 : 자잘한 변화
//
// # Last Update		: 2025.08.26 PM.01.45
// # Version			: 1.1.0
//
...
namespace r2
{
	class Direction8Bitwise
	{
	public:
		using StateT = r2::Direction8BitwiseState;
		...
		Direction8Bitwise();
		explicit Direction8Bitwise( const eState state );
		explicit Direction8Bitwise( const CoordinateT x, const CoordinateT y );
