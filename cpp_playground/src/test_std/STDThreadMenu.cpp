...
r2cm::MenuUp STDThreadMenu::Create( r2cm::Director& director )
{
...

	{
		...
		ret->AddItem( 'q', std_atomic_test::IsLockFree::GetInstance() );
		ret->AddItem( 'w', std_atomic_test::LockFreeTest1::GetInstance() );
		ret->AddItem( 'e', std_atomic_test::LockFreeTest2::GetInstance() );
