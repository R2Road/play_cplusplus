...
namespace r2algorithm
{
	...
	void AStarPathBuilder_Use_STDListSplice::Build( const r2::Point entry_point, const r2::Point exit_point, const r2::Grid<int>& grid, std::list<r2::Point>* out_result_path )
	{
		using Node4AStarContainerT = std::list<Node4AStar>;
		Node4AStarContainerT open_list;
		Node4AStarContainerT close_list;
	...
	void AStarPathBuilder_Use_STDListSplice_STDVectorResultPath::Build( const r2::Point entry_point, const r2::Point exit_point, const r2::Grid<int>& grid, std::vector<r2::Point>* out_result_path )
	{
		using Node4AStarContainerT = std::list<Node4AStar>;
		Node4AStarContainerT open_list;
		Node4AStarContainerT close_list;
	...
	void AStarPathBuilder_UseCostMap_TinyCostData_STDListSplice_STDVectorResultPath::Clear()
	{
		for( auto& c : cost_map )
		{
			c.Clear();
	...
	void AStarPathBuilder_UseCostMap_TinyCostData_STDListSplice_STDVectorResultPath::Build( const r2::Point entry_point, const r2::Point exit_point, const r2::Grid<int>& grid, std::vector<r2::Point>* out_result_path )
	{
		using TargetContainerT = std::list<r2::Point>;
		TargetContainerT open_list;
		TargetContainerT close_list;
	...
	void AStarPathBuilder_Use_ArrayBasedList_TinyCostMap_STDVectorResultPath::Build( const r2::Point entry_point, const r2::Point exit_point, const r2::Grid<int>& grid, std::vector<r2::Point>* out_result_path )
	{
		r2::Point current_point;
		bool bSuccess = false;
