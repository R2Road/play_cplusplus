...
namespace r2algorithm
{
	...
	void AStarPathBuilder_Use_TinyCostMap_STDListSplice_STDVectorResultPath::Build( const r2::Point entry_point, const r2::Point exit_point, const r2::Grid<int>& grid, std::vector<r2::Point>* out_result_path )
	{
		using TargetContainerT = std::list<r2::Point>;
		TargetContainerT open_list;
		TargetContainerT close_list;
