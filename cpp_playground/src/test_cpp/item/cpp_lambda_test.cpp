...
namespace cpp_lambda_test
{
	...
	r2cm::iItem::TitleFunctionT Size_Basic::GetTitleFunction() const
	{
		return []()->const char*
		{
	...
	r2cm::iItem::TitleFunctionT Size_ThisCapture::GetTitleFunction() const
	{
		return []()->const char*
		{
	...
	r2cm::iItem::DoFunctionT Size_ThisCapture::GetDoFunction() const
	{
		return []()->r2cm::eItemLeaveAction
		{
			std::cout << r2cm::split;
