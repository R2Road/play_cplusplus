...
r2cm::MenuUp STDCoutMenu::Create( r2cm::Director& director )
{
	...
	{
		ret->AddItem( '1', std_cout_test::FMTStatus::GetInstance() );
		ret->AddItem( '2', std_cout_test::NumberFormat_1::GetInstance() );
		ret->AddItem( '3', std_cout_test::NumberFormat_2::GetInstance() );
		ret->AddItem( '4', std_cout_test::NumberFormat_3::GetInstance() );
		ret->AddItem( '5', std_cout_test::NumberFormat_4::GetInstance() );
