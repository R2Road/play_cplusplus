...
r2tm::WriteFunctionT Menu_TemplateMetaProgramming::GetWriteFunction() const
{
	return[]( r2tm::MenuProcessor* mp )
	{
		...
		mp->AddItem( 'q', play_template_meta_programming_01::Character2String() );
		mp->AddItem( 'w', play_template_meta_programming_01::Integer2String() );
		mp->AddItem( 'e', play_template_meta_programming_01::CalculatePlaceValue() );
		mp->AddItem( 'r', play_template_meta_programming_01::Integer2String_II() );


		mp->AddLineFeed();


		mp->AddItem( 'a', play_template_meta_programming_01::MultiTypePackage() );
