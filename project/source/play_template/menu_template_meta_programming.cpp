...
r2tm::WriteFunctionT Menu_TemplateMetaProgramming::GetWriteFunction() const
{
	return[]( r2tm::MenuProcessor* mp )
	{
		...
		mp->AddItem( '2', play_template_meta_programming_01::Factorial_ProcessPrinter() );
		...
		mp->AddItem( 'c', play_template_meta_programming_01::TypeIndex() );
		mp->AddItem( 'v', play_template_meta_programming_01::MultiTypePackage() );
