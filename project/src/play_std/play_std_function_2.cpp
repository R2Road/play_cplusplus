	...
	r2tm::DoFunctionT Equality_STDBind_1::GetDoFunction() const
	{
		return []()->r2tm::eDoLeaveAction
		{
...

			{
				...
				auto fn_2 = sf1.target<void(play_std_function_2::NamedTestClass::*)()>();
				...
				std::cout << r2tm::tab2 << "auto fn_3 = sf1.target<void(play_std_function_2::NamedTestClass::*)()>();" << r2tm::linefeed2;
